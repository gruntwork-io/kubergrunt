...
func TestFindLatestEKSBuilds(t *testing.T) {
	...
	testCase := []struct {
		...
		{coreDNSVersionLookupTable, coreDNSRepoPath, "1.28", "us-east-1", "1.10.1-eksbuild.19"},
		{coreDNSVersionLookupTable, coreDNSRepoPath, "1.27", "us-east-1", "1.10.1-eksbuild.19"},
